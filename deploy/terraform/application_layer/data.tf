...
locals {
  ...
  rds_host_secret        = data.terraform_remote_state.infra.outputs.rds_host_secret_name
  rds_port_secret        = data.terraform_remote_state.infra.outputs.rds_port_secret_name
